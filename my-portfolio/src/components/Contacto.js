...
const Contacto = () => {
  ...
  return (
    <div className="animate-fade-in">
      <h1 className="text-3xl font-bold text-primary-800 mb-6">Contacto</h1>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="card hover:shadow-lg transition-all duration-300">
          <h2 className="text-xl font-semibold text-primary-700 mb-6">Información de Contacto</h2>
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">9997495334</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">eksanchezdiego24@gmail.com</p>
              </div>
            </div>
          ...
          <div className="mt-8">
            <h3 className="text-gray-800 font-medium mb-3">Redes Sociales</h3>
        ...
        <div className="card hover:shadow-lg transition-all duration-300">
          <h2 className="text-xl font-semibold text-primary-700 mb-6">Enviar Mensaje</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="subject" className="block text-gray-700 mb-1">Asunto</label>
              <input 
                type="text" 
                id="subject" 
                name="subject"
